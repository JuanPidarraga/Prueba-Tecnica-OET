...
@section('title', 'Registrar Vehículo - ACME Transportes')
...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-md p-8">
        <h1 class="text-3xl font-bold text-gray-800 mb-6">Registrar Nuevo Vehículo</h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="tipo_vehiculo" id="tipo_vehiculo" 
                        ...
                        <option value="particular" {{ old('tipo_vehiculo') == 'particular' ? 'selected' : '' }}>Particular</option>
                        <option value="publico" {{ old('tipo_vehiculo') == 'publico' ? 'selected' : '' }}>Público</option>
                    </select>
                    @error('tipo_vehiculo')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500">
                        ¿No encuentra el conductor? <a href="{{ route('conductores.create') }}" class="text-blue-600 hover:text-blue-800">Crear nuevo</a>
                    </p>
                </div>
                ...
                <div>
                    ...
                    @enderror
                    <p class="mt-1 text-xs text-gray-500">
                        ¿No encuentra el propietario? <a href="{{ route('propietarios.create') }}" class="text-blue-600 hover:text-blue-800">Crear nuevo</a>
                    </p>
                </div>
            </div>
