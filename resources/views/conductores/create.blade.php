...
@section('title', 'Registrar Conductor - ACME Transportes')
...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-md p-8">
        <h1 class="text-3xl font-bold text-gray-800 mb-6">Registrar Nuevo Conductor</h1>
        ...
        <form action="{{ route('conductores.store') }}" method="POST">
            ...
            <div class="mt-8 flex justify-end space-x-3">
                ...
                <button type="submit" class="btn-primary">Registrar Conductor</button>
            </div>
        </form>
    </div>
</div>
