...
@section('title', 'Editar Propietario - ACME Transportes')
...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-md p-8">
        <h1 class="text-3xl font-bold text-gray-800 mb-6">Editar Propietario</h1>
        ...
        <form action="{{ route('propietarios.update', $propietario) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="numero_cedula" id="numero_cedula" value="{{ old('numero_cedula', $propietario->numero_cedula) }}" 
                ...
                <div>
                    ...
                    <input type="text" name="primer_nombre" id="primer_nombre" value="{{ old('primer_nombre', $propietario->primer_nombre) }}" 
                ...
                <div>
                    ...
                    <input type="text" name="segundo_nombre" id="segundo_nombre" value="{{ old('segundo_nombre', $propietario->segundo_nombre) }}" 
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="apellidos" id="apellidos" value="{{ old('apellidos', $propietario->apellidos) }}" 
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="direccion" id="direccion" rows="3" 
                              class="input-field @error('direccion') border-red-500 @enderror" required>{{ old('direccion', $propietario->direccion) }}</textarea>
                    @error('direccion')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="telefono" id="telefono" value="{{ old('telefono', $propietario->telefono) }}" 
                ...
                <div>
                    ...
                    <input type="text" name="ciudad" id="ciudad" value="{{ old('ciudad', $propietario->ciudad) }}" 
            ...
            <div class="mt-8 flex justify-end space-x-3">
                <a href="{{ route('propietarios.index') }}" class="btn-secondary">Cancelar</a>
                <button type="submit" class="btn-primary">Actualizar Propietario</button>
            </div>
        </form>
    </div>
</div>
