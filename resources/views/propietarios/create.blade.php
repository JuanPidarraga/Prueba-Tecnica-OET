...
@section('title', 'Registrar Propietario - ACME Transportes')
...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-md p-8">
        <h1 class="text-3xl font-bold text-gray-800 mb-6">Registrar Nuevo Propietario</h1>
        ...
        <form action="{{ route('propietarios.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="numero_cedula" id="numero_cedula" value="{{ old('numero_cedula') }}" 
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="direccion" id="direccion" rows="3" 
                              class="input-field @error('direccion') border-red-500 @enderror" required>{{ old('direccion') }}</textarea>
                    @error('direccion')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
